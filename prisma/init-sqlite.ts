...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS "Release" (
    ...
    "reviewReason" TEXT,
    "previousReleaseDate" DATETIME,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
  `CREATE TABLE IF NOT EXISTS "ReleaseSyncLog" (
    "id" TEXT NOT NULL PRIMARY KEY,
  ...
  `CREATE TABLE IF NOT EXISTS "InventoryItem" (
    ...
    "marketProviderMatchedAt" DATETIME,
    "marketProviderLastPricedAt" DATETIME,
  ...
  `CREATE TABLE IF NOT EXISTS "TcgcsvProduct" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "tcgcsvProductId" TEXT NOT NULL UNIQUE,
  ...
  `CREATE TABLE IF NOT EXISTS "TcgcsvSyncLog" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "status" TEXT NOT NULL,
    "startedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "finishedAt" DATETIME,
  ...
  `CREATE TABLE IF NOT EXISTS "InventorySale" (
    ...
    CONSTRAINT "InventorySale_customerAccountId_fkey" FOREIGN KEY ("customerAccountId") REFERENCES "CustomerAccount" ("id") ON DELETE SET NULL ON UPDATE CASCADE
  )`,
  ...
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "featuredHeroProductId" TEXT`,
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "homepageHeroMode" TEXT NOT NULL DEFAULT 'automatic_latest'`,
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "newArrivalDays" INTEGER NOT NULL DEFAULT 14`,
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "showSoldOutInHero" BOOLEAN NOT NULL DEFAULT true`,
  `ALTER TABLE "Release" ADD COLUMN "releaseName" TEXT`,
  `ALTER TABLE "Release" ADD COLUMN "productName" TEXT`,
  `ALTER TABLE "Release" ADD COLUMN "releaseType" TEXT NOT NULL DEFAULT 'expansion'`,
  `ALTER TABLE "Release" ADD COLUMN "preorderWindowText" TEXT`,
  `ALTER TABLE "Release" ADD COLUMN "region" TEXT NOT NULL DEFAULT 'US'`,
  `ALTER TABLE "Release" ADD COLUMN "retailer" TEXT`,
  `ALTER TABLE "Release" ADD COLUMN "productImage" TEXT`,
  `ALTER TABLE "Release" ADD COLUMN "productUrl" TEXT`,
  `ALTER TABLE "Release" ADD COLUMN "supportingSources" TEXT`,
  `ALTER TABLE "Release" ADD COLUMN "sourceUrl" TEXT`,
  `ALTER TABLE "Release" ADD COLUMN "sourceName" TEXT`,
  `ALTER TABLE "Release" ADD COLUMN "sourceType" TEXT NOT NULL DEFAULT 'manual'`,
  `ALTER TABLE "Release" ADD COLUMN "confidence" TEXT NOT NULL DEFAULT 'MEDIUM'`,
  `ALTER TABLE "Release" ADD COLUMN "status" TEXT NOT NULL DEFAULT 'upcoming'`,
  `ALTER TABLE "Release" ADD COLUMN "lastSyncedAt" DATETIME`,
  `ALTER TABLE "Release" ADD COLUMN "createdByManualEntry" BOOLEAN NOT NULL DEFAULT true`,
  `ALTER TABLE "Release" ADD COLUMN "needsReview" BOOLEAN NOT NULL DEFAULT false`,
  `ALTER TABLE "Release" ADD COLUMN "reviewReason" TEXT`,
  `ALTER TABLE "Release" ADD COLUMN "previousReleaseDate" DATETIME`,
  `ALTER TABLE "InventoryItem" ADD COLUMN "marketProvider" TEXT`,
  `ALTER TABLE "InventoryItem" ADD COLUMN "marketProviderProductId" TEXT`,
  `ALTER TABLE "InventoryItem" ADD COLUMN "marketProviderProductName" TEXT`,
  `ALTER TABLE "InventoryItem" ADD COLUMN "marketProviderMatchStatus" TEXT NOT NULL DEFAULT 'UNMATCHED'`,
  `ALTER TABLE "InventoryItem" ADD COLUMN "marketProviderConfidenceScore" INTEGER NOT NULL DEFAULT 0`,
  `ALTER TABLE "InventoryItem" ADD COLUMN "marketProviderMatchReason" TEXT`,
  `ALTER TABLE "InventoryItem" ADD COLUMN "marketProviderMatchedAt" DATETIME`,
  `ALTER TABLE "InventoryItem" ADD COLUMN "marketProviderLastPricedAt" DATETIME`,
  `ALTER TABLE "InventoryItem" ADD COLUMN "publishedAt" DATETIME`,
  ...
  `ALTER TABLE "InventorySale" ADD COLUMN "originalUnitPrice" REAL`,
  `ALTER TABLE "InventorySale" ADD COLUMN "adjustedUnitPrice" REAL`,
  `ALTER TABLE "InventorySale" ADD COLUMN "discountAmount" REAL`,
  ...
  `ALTER TABLE "InventorySale" ADD COLUMN "customerLinkedAt" DATETIME`,
  ...
  `ALTER TABLE "InventorySale" ADD COLUMN "refundedAmount" REAL NOT NULL DEFAULT 0`,
  `ALTER TABLE "InventorySale" ADD COLUMN "refundedAt" DATETIME`,
  ...
  `ALTER TABLE "StorefrontOrder" ADD COLUMN "testMarkedAt" DATETIME`,
  ...
  `CREATE INDEX IF NOT EXISTS "Release_officialReleaseDate_idx" ON "Release"("officialReleaseDate")`,
  `CREATE INDEX IF NOT EXISTS "Release_preorderDate_idx" ON "Release"("preorderDate")`,
  `CREATE INDEX IF NOT EXISTS "Release_status_idx" ON "Release"("status")`,
  `CREATE INDEX IF NOT EXISTS "Release_needsReview_idx" ON "Release"("needsReview")`,
  `CREATE INDEX IF NOT EXISTS "ReleaseSyncLog_checkedAt_idx" ON "ReleaseSyncLog"("checkedAt")`,
  `CREATE INDEX IF NOT EXISTS "ReleaseSyncLog_adapter_idx" ON "ReleaseSyncLog"("adapter")`,
  `CREATE INDEX IF NOT EXISTS "ReleaseSyncLog_status_idx" ON "ReleaseSyncLog"("status")`,
  ...
  `CREATE INDEX IF NOT EXISTS "InventoryItem_marketProvider_idx" ON "InventoryItem"("marketProvider")`,
  `CREATE INDEX IF NOT EXISTS "InventoryItem_marketProviderProductId_idx" ON "InventoryItem"("marketProviderProductId")`,
  `CREATE INDEX IF NOT EXISTS "InventoryItem_marketProviderMatchStatus_idx" ON "InventoryItem"("marketProviderMatchStatus")`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS "TcgcsvProduct_tcgcsvProductId_key" ON "TcgcsvProduct"("tcgcsvProductId")`,
  `CREATE INDEX IF NOT EXISTS "TcgcsvProduct_categoryId_idx" ON "TcgcsvProduct"("categoryId")`,
  `CREATE INDEX IF NOT EXISTS "TcgcsvProduct_groupId_idx" ON "TcgcsvProduct"("groupId")`,
  `CREATE INDEX IF NOT EXISTS "TcgcsvProduct_normalizedName_idx" ON "TcgcsvProduct"("normalizedName")`,
  `CREATE INDEX IF NOT EXISTS "TcgcsvProduct_groupName_idx" ON "TcgcsvProduct"("groupName")`,
  `CREATE INDEX IF NOT EXISTS "TcgcsvProduct_lastSyncedAt_idx" ON "TcgcsvProduct"("lastSyncedAt")`,
  `CREATE INDEX IF NOT EXISTS "TcgcsvSyncLog_startedAt_idx" ON "TcgcsvSyncLog"("startedAt")`,
  `CREATE INDEX IF NOT EXISTS "TcgcsvSyncLog_status_idx" ON "TcgcsvSyncLog"("status")`,
  ...
  `CREATE INDEX IF NOT EXISTS "InventorySale_customerLinkSource_idx" ON "InventorySale"("customerLinkSource")`,
  `CREATE INDEX IF NOT EXISTS "InventorySale_customerLinkedByUserId_idx" ON "InventorySale"("customerLinkedByUserId")`,
  `CREATE INDEX IF NOT EXISTS "InventorySale_rewardsEligible_idx" ON "InventorySale"("rewardsEligible")`,
  `CREATE INDEX IF NOT EXISTS "InventorySale_refundStatus_idx" ON "InventorySale"("refundStatus")`,
  `CREATE INDEX IF NOT EXISTS "InventorySale_refundIdempotencyKey_idx" ON "InventorySale"("refundIdempotencyKey")`,
  ...
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "taxProfileEffectiveAt" DATETIME`,
  ...
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "taxOwnerApprovedAt" DATETIME`,
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "taxAccountantReviewedAt" DATETIME`,
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "taxAccountantReviewedByUserId" TEXT`,
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "taxAccountantReviewNote" TEXT`,
  ...
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "legacyManualTaxFallbackIncidentReason" TEXT`,
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "legacyManualTaxFallbackAcknowledgedAt" DATETIME`,
  `ALTER TABLE "StorefrontSettings" ADD COLUMN "legacyManualTaxFallbackExpiresAt" DATETIME`,
  ...
  `ALTER TABLE "StorefrontOrder" ADD COLUMN "taxCalculatedAt" DATETIME`,
  ...
  `ALTER TABLE "InventorySale" ADD COLUMN "taxCalculatedAt" DATETIME`,
  ...
  `CREATE INDEX IF NOT EXISTS "TaxLocation_userId_active_idx" ON "TaxLocation"("userId", "active")`,
  `CREATE INDEX IF NOT EXISTS "TaxLocation_userId_defaultForPos_idx" ON "TaxLocation"("userId", "defaultForPos")`,
  `CREATE INDEX IF NOT EXISTS "TaxLocation_userId_defaultForLocalPickup_idx" ON "TaxLocation"("userId", "defaultForLocalPickup")`,
  `CREATE INDEX IF NOT EXISTS "TaxLocation_userId_defaultShipFrom_idx" ON "TaxLocation"("userId", "defaultShipFrom")`,
  `CREATE TABLE IF NOT EXISTS "TaxCertificationEvidence" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "userId" TEXT NOT NULL,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS "TaxCertificationEvidence_userId_scenario_buildCommit_providerMode_key" ON "TaxCertificationEvidence"("userId", "scenario", "buildCommit", "providerMode")`,
  `CREATE INDEX IF NOT EXISTS "TaxCertificationEvidence_userId_status_idx" ON "TaxCertificationEvidence"("userId", "status")`,
  `CREATE INDEX IF NOT EXISTS "TaxCertificationEvidence_userId_runAt_idx" ON "TaxCertificationEvidence"("userId", "runAt")`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS "TaxAdjustment_idempotencyKey_key" ON "TaxAdjustment"("idempotencyKey")`,
  `CREATE INDEX IF NOT EXISTS "TaxAdjustment_storefrontOrderId_idx" ON "TaxAdjustment"("storefrontOrderId")`,
  `CREATE INDEX IF NOT EXISTS "TaxAdjustment_inventorySaleId_idx" ON "TaxAdjustment"("inventorySaleId")`,
  `CREATE INDEX IF NOT EXISTS "TaxAdjustment_saleReference_idx" ON "TaxAdjustment"("saleReference")`,
  `CREATE INDEX IF NOT EXISTS "TaxAdjustment_channel_createdAt_idx" ON "TaxAdjustment"("channel", "createdAt")`,
  `CREATE INDEX IF NOT EXISTS "StorefrontOrder_taxStatus_idx" ON "StorefrontOrder"("taxStatus")`,
  `CREATE INDEX IF NOT EXISTS "StorefrontOrder_taxJurisdictionState_taxJurisdictionCounty_idx" ON "StorefrontOrder"("taxJurisdictionState", "taxJurisdictionCounty")`,
  `CREATE INDEX IF NOT EXISTS "InventorySale_taxStatus_idx" ON "InventorySale"("taxStatus")`,
  `CREATE INDEX IF NOT EXISTS "InventorySale_taxCalculationId_idx" ON "InventorySale"("taxCalculationId")`,
  `CREATE INDEX IF NOT EXISTS "InventorySale_taxTransactionId_idx" ON "InventorySale"("taxTransactionId")`,
  `CREATE INDEX IF NOT EXISTS "InventorySale_taxTransactionStatus_idx" ON "InventorySale"("taxTransactionStatus")`,
  `CREATE INDEX IF NOT EXISTS "InventorySale_taxJurisdictionState_taxJurisdictionCounty_idx" ON "InventorySale"("taxJurisdictionState", "taxJurisdictionCounty")`,
  `CREATE INDEX IF NOT EXISTS "InventorySale_taxLocationId_idx" ON "InventorySale"("taxLocationId")`,
  `CREATE INDEX IF NOT EXISTS "StorefrontOrder_taxLocationId_idx" ON "StorefrontOrder"("taxLocationId")`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS "PublicRateLimit_action_rule_keyHash_windowStart_key" ON "PublicRateLimit"("action", "rule", "keyHash", "windowStart")`,
  ...
  `CREATE INDEX IF NOT EXISTS "StorefrontOrder_customerLinkSource_idx" ON "StorefrontOrder"("customerLinkSource")`,
  `CREATE INDEX IF NOT EXISTS "StorefrontOrder_customerLinkedByUserId_idx" ON "StorefrontOrder"("customerLinkedByUserId")`,
