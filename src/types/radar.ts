...
export type CustomerRewardIntegrityReportDTO = {
  ...
  sections: {
    ...
    customerAccountIntegrity: CustomerRewardIntegritySectionDTO<{
      ...
      accountsMissingNormalizedEmailVerified: number;
      accountsMissingNormalizedEmailUnverified: number;
      accountsMissingNormalizedEmailActive: number;
      accountsMissingNormalizedEmailInactive: number;
      accountsMissingNormalizedEmailWithRewardBalance: number;
      accountsMissingNormalizedEmailWithoutRewardBalance: number;
      accountsMissingNormalizedEmailWithLedgerEntries: number;
      accountsMissingNormalizedEmailWithoutLedgerEntries: number;
      accountsMissingNormalizedEmailLinkedStorefrontCustomer: number;
      accountsMissingNormalizedEmailUnlinkedStorefrontCustomer: number;
      accountsMissingNormalizedEmailLinkedPaidOrder: number;
      accountsMissingNormalizedEmailWithoutLinkedPaidOrder: number;
      accountsMissingNormalizedEmailLinkedPosTransaction: number;
      accountsMissingNormalizedEmailWithoutLinkedPosTransaction: number;
      accountsWithoutRewardBalanceWithLedgerEntries: number;
      accountsWithoutRewardBalanceWithoutLedgerEntries: number;
      accountsWithoutRewardBalanceWithPositiveRewardPoints: number;
      accountsWithoutRewardBalanceWithOnlyZeroOrNoRewardHistory: number;
      accountsWithoutRewardBalanceVerified: number;
      accountsWithoutRewardBalanceActive: number;
      accountsWithoutRewardBalanceNormalizedEmailPresent: number;
      accountsWithoutRewardBalanceNormalizedEmailMissing: number;
    ...
    rewardLedgerIntegrity: CustomerRewardIntegritySectionDTO<{
      ...
      reversalRelationshipVerificationAvailable: boolean;
      ...
      positiveEarnPending: number;
      positiveEarnAvailable: number;
      positiveEarnCanceledWithSupportedReversal: number;
      positiveEarnCanceledWithoutReversal: number | null;
      positiveEarnReversed: number;
      negativeReverseReversed: number;
      ...
      invalidNegativeEarn: number;
      invalidNegativePending: number;
    ...
    posRewards: CustomerRewardIntegritySectionDTO<{
      ...
      linkedPosSalesWithoutEarnEntry: number | null;
      linkedPosSalesWithoutEarnRewardsEligibleTrue: number | null;
      linkedPosSalesWithoutEarnRewardsEligibleFalse: number | null;
      linkedPosSalesWithoutEarnRewardsEligibleMissing: number | null;
      linkedPosSalesWithoutEarnBeforeFirstPersistedPosEarn: number | null;
      linkedPosSalesWithoutEarnAfterFirstPersistedPosEarn: number | null;
      linkedPosSalesWithoutEarnActivationUnknown: number | null;
      linkedPosSalesWithoutEarnLinkedAccountVerified: number | null;
      linkedPosSalesWithoutEarnLinkedAccountUnverified: number | null;
      linkedPosSalesWithoutEarnZeroEligibleMerchandiseSubtotal: number | null;
...
export type InventorySaleDTO = {
  ...
  grossSale: number;
  activeGrossSale: number;
  platform: string;
  fees: number;
  shippingCost: number;
  netSale: number;
  activeNetSale: number;
  costBasis: number;
  ...
  combinedRateBasisPoints: number | null;
  taxJurisdictionCountry: string | null;
  taxJurisdictionState: string | null;
  taxJurisdictionCounty: string | null;
  taxStatus: string | null;
...
export type ProductDTO = {
  ...
  fulfillmentType: "target_ship" | "pickup" | "marketplace_ship" | "unknown";
  sellerVerified: boolean;
  priceStatus: "msrp" | "near_retail" | "over_msrp" | "marketplace_price" | "unknown";
  alertEligibility: "eligible" | "suppressed_over_msrp" | "suppressed_marketplace" | "needs_review";
