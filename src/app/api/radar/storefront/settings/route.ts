...
export async function PATCH(request: Request) {
  ...
  try {
    ...
    const data = {
      ...
      featuredHeroProductId: input.featuredHeroProductId ?? null,
      homepageHeroMode: input.homepageHeroMode,
      newArrivalDays: input.newArrivalDays,
      showSoldOutInHero: input.showSoldOutInHero,
