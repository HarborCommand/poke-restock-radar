...
export const storefrontCollections: StorefrontCollectionDefinition[] = [
  ...
  },
  {
    ...
    metaDescription: "Shop Pokémon tins and Poké Ball tins from GameDayGrabs. Products are packed carefully and availability is confirmed during checkout.",
    intro: "Shop Pokémon tins, mini tins, and Poké Ball-style sealed products.",
  ...
  },
  {
    ...
    metaDescription: "Shop Pokémon premium collections and collector boxes from GameDayGrabs with careful packaging, secure checkout, and order support.",
    intro: "Shop Pokémon premium collections and collector-focused boxed products.",
