...
export const publicRateLimitRules: Record<PublicRateLimitAction, PublicRateLimitRule[]> = {
  ...
  admin_tax_provider_check: [
    { rule: "client_10m", scope: "client", windowSeconds: 10 * 60, maxAttempts: 6, blockSeconds: 10 * 60 },
    { rule: "client_burst_1m", scope: "client", windowSeconds: 60, maxAttempts: 2, blockSeconds: 5 * 60 }
  ],
  client_error: [
